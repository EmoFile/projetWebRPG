...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chest', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chestInventory', to='app.Chest')),
            ],
        ),
        migrations.CreateModel(
            name='Party',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enemy', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app.Enemy')),
                ('party', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app.Party')),
            ],
        ),
        migrations.AddField(
            model_name='party',
        ...
        migrations.AddField(
            ...
            name='characterClass',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='characterClass', to='app.CharacterClass'),
        ),
        migrations.AddField(
            model_name='character',
            name='inventory',
